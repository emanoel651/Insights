...
# -------------------------------------------------------------------
# Defina o caminho correto do seu Excel (coloque-o na raiz do seu app)
# -------------------------------------------------------------------
...
st.plotly_chart(fig1, use_container_width=True, key="evolucao_status")
...
st.plotly_chart(fig2, use_container_width=True, key="evolucao_cancelado")
...
st.plotly_chart(fig3, use_container_width=True, key="evolucao_vendas")
...
st.plotly_chart(fig4, use_container_width=True, key="top_cidades")
...
st.plotly_chart(fig5, use_container_width=True, key="top_meso")
...
st.plotly_chart(fig6, use_container_width=True, key="top_micro")
...
fig_extra = px.bar(
    ...
    hover_data=["Mesorregiao","Microrregiao"], labels={"Valor_Servicos":"R$"}
)
st.plotly_chart(fig_extra, use_container_width=True, key="top_cidade_meso_micro")
...
fig7 = px.bar(
    city_by_meso, x="Valor_Servicos", y="Cidade",
    orientation="h", text_auto=".2s", color="Mesorregiao", labels={"Valor_Servicos":"R$"}
)
st.plotly_chart(fig7, use_container_width=True, key="top_cidade_por_meso")
...
fig8 = px.bar(
    city_by_micro, x="Valor_Servicos", y="Cidade",
    orientation="h", text_auto=".2s", color="Microrregiao", labels={"Valor_Servicos":"R$"}
)
st.plotly_chart(fig8, use_container_width=True, key="top_cidade_por_micro")
